...
public:
    ...
    DoubleBuffer(tl::optional<TBufferHost> h,
                 TBufferDevice d,
                 typename TAccelerator::Queue*,
                 std::size_t numMaps)
...
private:
    ...
    static typename TAccelerator::template HostView<T>
    getView(FramePackageView<T,
                             TAccelerator,
                             typename TAccelerator::template HostView<T>> buf,
            std::size_t numMaps)
    {
        (void)numMaps;
        return buf.data;
    ...
    getView(typename TAccelerator::template HostBuf<T> buf, std::size_t numMaps)
    {
        ...
        return
            typename TAccelerator::template HostView<T>(buf, numMaps, offset);
    }
...
class FramePackageDoubleBuffer
    : public GetDoubleBuffer<TAccelerator,
                             decltype(TBufferHost::data),
                             TBufferDevice>::Buffer {
public:
    FramePackageDoubleBuffer(tl::optional<TBufferHost> h,
                             TBufferDevice d,
                             typename TAccelerator::Queue* queue,
                             std::size_t numMaps)
        : GetDoubleBuffer<TAccelerator,
                          decltype(TBufferHost::data),
                          TBufferDevice>::
    ...
    FramePackageDoubleBuffer(TBufferHost h,
                             TBufferDevice d,
                             typename TAccelerator::Queue* queue,
                             std::size_t numMaps)
        : GetDoubleBuffer<TAccelerator,
