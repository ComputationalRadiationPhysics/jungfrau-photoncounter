...
%\definechangesauthor[name={Jonas}, color=pink]{Jonas}
%\setremarkmarkup{(#2)}
...
%TODO: common calibration and preprocessing steps / online preprocessing -> FPGAs
%TODO: offline preprocessing -> XDS, ...
%TODO: further analysis -> crystallography
%TODO: related acceleration libraries
